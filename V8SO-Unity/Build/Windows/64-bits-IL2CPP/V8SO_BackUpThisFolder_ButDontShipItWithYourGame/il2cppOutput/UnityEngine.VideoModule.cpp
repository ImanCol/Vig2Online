...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_4);
		EventHandler_Invoke_m8A3288B6DF1FE2699A58EA22D0B830BB20E94E15(L_4, L_5, NULL);
	}
...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_4);
		FrameReadyEventHandler_Invoke_m73FF71F81A620194421226D8A98C64FB82E7B235(L_4, L_5, L_6, NULL);
	}
...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_4);
		ErrorEventHandler_Invoke_m0601D855B85F5053A0A10A0166A8CE469D4672C5(L_4, L_5, L_6, NULL);
	}
...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_4);
		TimeEventHandler_Invoke_m2327761543815FB7181FFF73E87FC5EC0F84349D(L_4, L_5, L_6, NULL);
	}
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// closed
				typedef void (*FunctionPointerType) (void*, VideoPlayer_t48EA4A8117B822BC59590150DED9AD46C62F65D3*, const RuntimeMethod*);
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// closed
				typedef void (*FunctionPointerType) (void*, VideoPlayer_t48EA4A8117B822BC59590150DED9AD46C62F65D3*, String_t*, const RuntimeMethod*);
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// closed
				typedef void (*FunctionPointerType) (void*, VideoPlayer_t48EA4A8117B822BC59590150DED9AD46C62F65D3*, int64_t, const RuntimeMethod*);
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// closed
				typedef void (*FunctionPointerType) (void*, VideoPlayer_t48EA4A8117B822BC59590150DED9AD46C62F65D3*, double, const RuntimeMethod*);
